...
@Fork(value = 4, jvmArgs = {"-Xmn8G"})
@Warmup(iterations = 4, time = 4500, timeUnit = TimeUnit.MILLISECONDS)
@Measurement(iterations = 3, time = 4000, timeUnit = TimeUnit.MILLISECONDS)
public class WiredList_50M_replace_500K_Start {

  public static int LIST_SIZE = 50_000_000;
  private static int SEGMENT_SIZE = 500_000;
  ...
  public void prepare() {
    ...
    from = rand.nextInt(10, 21);
    to = from + SEGMENT_SIZE + rand.nextInt(-5, 4);
  }
